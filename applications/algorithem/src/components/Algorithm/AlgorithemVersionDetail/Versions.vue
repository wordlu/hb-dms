    ...
    <div class="panel">
      <div class="mid-panel">
        ...
        <div class="mid-group">
          ...
          <div class="ver-mid">
            <el-button type="info" class="info-btn" plain :disabled="isDeleteBtnDisabled" @click="remove"
...
const rowClicked = (row: Row) => {
  window.history.pushState(null, '', `/algorithem/detail/${props.algorithem}/version/${row.id}`)
}
