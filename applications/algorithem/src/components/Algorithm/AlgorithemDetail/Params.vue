  ...
  <div class="container">
    <div class="panel">
      <div class="mid-panel">
        <div class="mid-group">
          <div class="ver-mid">
            <el-button type="primary" class="info-btn save-btn" @click="submitForm(ruleFormRef)">{{ $t(`common['编辑']`) }}</el-button>
          </div>
        </div>
      </div>
    </div>
...
const submitForm = async (formEl: any) => {
  window.history.pushState(null, '', `/algorithem/detail/${props.algorithemId}/params/creation?name=${props.name}&version0=${props.algorithemversionId}`)
}
